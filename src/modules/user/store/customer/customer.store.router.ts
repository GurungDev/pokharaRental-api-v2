...
Store_customerRouter.get("/", Validator.validate(LocationDto, RequestDataPaths.Query), storeCustomerController.get.bind(storeCustomerController));//get many stores
