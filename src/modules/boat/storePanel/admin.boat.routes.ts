...
adminBoatRouter.patch("/:id", authMiddleware,storeChecker,uploadImage(), Validator.validate(ValidateId, RequestDataPaths.Params),Validator.validate(CreateBoatDto, RequestDataPaths.Body), adminBoatController.patch.bind(adminBoatController));
